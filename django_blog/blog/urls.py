...
urlpatterns = [
    ...
    path('post/<int:post_id>/comments/<int:pk>/edit/', views.update_comment, name='comment-update'),

    # URL for deleting a comment
    path('post/<int:post_id>/comments/<int:pk>/delete/', views.delete_comment, name='comment-delete'),
]
